...
<div class="hero common-hero">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="hero-ct">
					<h1><span class="fa fa-calendar-o"></span>&nbsp;&nbsp;Upcoming Events</h1>
					{{-- <ul class="breadcumb">
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							...
							<div class="blog-it-infor">
								<h3><a href="/event_details">Godzilla: King Of The Monsters Adds O’Shea Jackson Jr</a></h3>
