            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="blog-detail-ct">
                        ...
                        {{-- <center><h1 id="mfi-page-title">ABOUT US</h1></center><br><br> --}}
                        <h1 id="what-is-mfi"><strong style="font-weight: lighter;">What is <b>MOWELFUND FILM INSTITUTE?</b>
                            {{-- <span>
                                <img src="{{ $appearance->logo_url }}" style="height: 60px"/>
                            </span>? --}}
                        </strong></h1>
                        {!! $appearance->about !!}
                        ...
                        <div class="flex-it share-tag">
                            <div class="social-link pull-right">
                                <h4>Follow Us</h4>
                                <a target="_blank" href="{{ $appearance->fb_link }}"><span class="fa fa-facebook-official"></span></a>
                                {{-- <a target="_blank" href="{{ $appearance->tw_link }}"><i class="ion-social-twitter"></i></a> --}}
                                <a target="_blank" href="{{ $appearance->insta_link }}"><span class="fa fa-instagram"></span></a>
