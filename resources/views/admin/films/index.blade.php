        ...
        <div class="col-md-5">
            ...
            @endif
                <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        {!! Form::open(['method'=>'POST','action'=>'CategoryController@store','autocomplete'=>'off']) !!}
                          <div class="box-body">
                                        ...
                                        <table id="example" class="display table table-striped table-hover" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <td><input type="checkbox" value="{{$cat->id}}" name="delCheckBox[]" class="checkBoxes"></td>
                                                    <td>{{$cat->name}}</td>
                                                    <td>{{$cat->slug}}</td>
                                                    <td><a data-toggle="tooltip" title="Update" href="{{action('CategoryController@edit',$cat->slug)}}"><span><i class="fa fa-edit" style="font-size:24px"></i></span></a></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                            <tfoot>
