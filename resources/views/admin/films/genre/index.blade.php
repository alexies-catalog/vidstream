...
<div class="row">
            ...
            @endif
                <div class="box box-info">
                        <div class="box-header with-border">
                          <h3 class="box-title">Add New Genre</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        {!! Form::open(['method'=>'POST','action'=>'admin\GenreController@store','autocomplete'=>'off']) !!}
                          <div class="box-body">
                          ...
                          <div class="box-footer">
                                {!! Form::submit('Add New Genre',['class' => 'btn btn-info pull-right']) !!}
                            </div>
                          <!-- /.box-footer -->
                          {!!Form::close()!!}
                </div>
        ...
        <div class="col-md-7">
                <div class="box">
                        <form method="post" action="/delete/genre" class="form-inline">
                            @method('DELETE')
                            @csrf
                        <div class="box-header with-border">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table id="example" class="display table table-striped table-hover" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                <td><input type="checkbox" value="{{$genre->id}}" name="delCheckBox[]" class="checkBoxes"></td>
                                                    <td>{{$genre->name}}</td>
                                                    <td>{{$genre->slug}}</td>
                                                    <td><a data-toggle="tooltip" title="Update" href="{{action('admin\GenreController@edit',$genre->slug)}}"><span><i class="fa fa-edit" style="font-size:24px"></i></span></a></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                            <tfoot>
