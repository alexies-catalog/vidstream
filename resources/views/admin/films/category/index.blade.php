...
<div class="row">
        <div class="col-md-5">
            ...
            @endif
                <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        {!! Form::open(['method'=>'POST','action'=>'admin\CategoryController@store','autocomplete'=>'off']) !!}
                          <div class="box-body">
                          ...
                          <div class="box-footer">
                                {!! Form::submit('Add New Category',['class' => 'btn btn-info pull-right']) !!}
                            </div>
                          <!-- /.box-footer -->
                          {!!Form::close()!!}
                </div>
        ...
        <div class="col-md-7">
                <div class="box">
                        <form method="post" action="/delete/category" class="form-inline">
                            @method('DELETE')
                            @csrf
                        <div class="box-header with-border">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table id="example" class="display table table-striped table-hover" style="width:100%">
                                            ...
                                            <tbody>
                                                @foreach ($cats as $cat)
                                                <tr>
                                                <td><input type="checkbox" value="{{$cat->id}}" name="delCheckBox[]" class="checkBoxes"></td>
                                                    <td>{{$cat->name}}</td>
                                                    <td>{{$cat->slug}}</td>
                                                    <td><a data-toggle="tooltip" title="Update" href="{{action('admin\CategoryController@edit',$cat->slug)}}"><span><i class="fa fa-edit" style="font-size:24px"></i></span></a></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                            <tfoot>
