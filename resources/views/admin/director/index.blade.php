...
<div class="row" style="padding:10px">
    <div class="box">
        <form method="post" action="/delete/director" class="form-inline">
            @method('DELETE')
            @csrf
        <div class="box-header with-border">
            <a href="{{route('director.create')}}" class="btn btn-info pull-right">Add New Director</a>
                    ...
                    <div class="col-md-12">
                        ...
                        <table id="example" class="display table table-striped table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                <td><input type="checkbox" value="{{$director->id}}" name="delCheckBox[]" class="checkBoxes"></td>
                                    <td>{{$director->name}}</td>
                                    <td>{{$director->created_at}}</td>
                                    <td><a data-toggle="tooltip" title="Update" href="{{action('admin\DirectorController@edit',$director->slug)}}"><span><i class="fa fa-edit" style="font-size:24px"></i></span></a>
