...
<div class="row" style="padding:10px">
    ...
    <div class="box box-info">
        ...
        {!! Form::model($director, ['method'=>'PATCH','action'=>['admin\DirectorController@update',$director->id],'autocomplete'=>'off','files' => true]) !!}
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <img class="displayImg" src=" {{ asset("$director->profilepic") }} " alt="your image" style="width:270px;height:400px"/>
                </div>
            </div>
