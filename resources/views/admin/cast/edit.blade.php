...
<div class="row" style="padding:10px">
    ...
    <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Update Cast</h3>
        </div>
        {!! Form::model($cast, ['method'=>'PATCH','action'=>['admin\CastController@update',$cast->id],'autocomplete'=>'off','files' => true]) !!}
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <img class="displayImg" src=" {{ asset("$cast->profilepic") }} " alt="your image" style="width:270px;height:400px"/>
                </div>
            </div>
            <div class="box-footer">
                {!! Form::submit('Update Director',['class' => 'btn btn-info pull-right']) !!}
            </div>
