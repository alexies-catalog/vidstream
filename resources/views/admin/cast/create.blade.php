...
<div class="row" style="padding:10px">
    <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Add New Cast</h3>
        </div>
        {!! Form::open(['method'=>'POST','action'=>'admin\CastController@store','autocomplete'=>'off','files' => true]) !!}
            <div class="box-body">
            ...
            <div class="box-footer">
                {!! Form::submit('Add New Cast',['class' => 'btn btn-info pull-right']) !!}
            </div>
