        ...
        <div class="row ipad-width2">
            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="topbar-filter">
                    ...
                    <label>Sort by:</label>
                    <select v-model="sortKey" @change="getActor()">
                ...
                <div class="celebrity-items">
                    <div class="ceb-item"  v-for="actor in actors" :key="actor.id" >
                        <a href="celebritysingle.html"><img :src="actor.profilepic" alt=""></a>
                        <div class="ceb-infor">
...
export default {
    ...
    methods: {
        ...
        next() {
            ...
            this.getActor(this.pagination.nextPageUrl);
        },
        prev() {
            this.$nextTick(function(){
                document.body.scrollTop = 0;
            ...
            this.getActor(this.pagination.prevPageUrl);
        },
        sortChange(){
            // alert(this.sortKey);
